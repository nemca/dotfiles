...
export CDPATH="$HOME/git/nemca:$HOME/git/mixanemca:$HOME/git/perfectcircletech:$HOME/go/src/github.com/mixanemca:$HOME/go/src/github.com/nemca:$HOME/git/p2p-org"
